...
class MANO(nn.Module):
    def __init__(self):
        ...
        self.mano_dir = 'AMVUR/modeling/data'
    ...
    def get_layer(self,flat_hand_mean=False):
        return ManoLayer(mano_root=osp.join(self.mano_dir), flat_hand_mean=flat_hand_mean, use_pca=False) # load right hand MANO model
